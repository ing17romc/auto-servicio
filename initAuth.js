...
const initAuth = () => {
	init({
		authPageURL: CONFIG.ROUTER.USUARIOS.LOGIN,
		appPageURL: CONFIG.ROUTER.START_APP,
		...
		firebaseAdminInitConfig: {
			credential: {
				...
				clientEmail: 'firebase-adminsdk-qmcas@auto-servicios-cero-humedad.iam.gserviceaccount.com',
